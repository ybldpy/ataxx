...
class Move {
    ...
    static boolean isClone(String location0, String location1) {
        ...
        return !location0.equals(location1)&&Math.abs(c0-c1)<=1&&Math.abs(r0-r1)<=1;
    }
    ...
    static boolean isJump(String location0, String location1) {
        ...
        int rD = Math.abs(r0-r1);
        int cD = Math.abs(c0-c1);
        return !location0.equals(location1) && ((rD>1||cD>1)&&rD<=2&&cD<=2);
    }
